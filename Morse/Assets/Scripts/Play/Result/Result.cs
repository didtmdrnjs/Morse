...
public class Result : MonoBehaviour
{
    ...
    {
        string path = Application.streamingAssetsPath + "/Music/" + data.name + "/" + (GameManager.instance.mode == EMode.OneWord ? "One" : "Two") + (GameManager.instance.difficulty == 0 ? "Easy" : "Hard") + ".json";
